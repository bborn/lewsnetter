...
{Demo}[https://rails4-LewsNetter.herokuapp.com] — Bootstrap 3

{Email Template Preview}[https://rails4-LewsNetter.herokuapp.com/p/email?premail=true&layout=email] — with inline CSS via Premailer
...
* Bootstrap3[http://getbootstrap.com/] enabled — master[https://github.com/LewsNetters/rails4-LewsNetter/tree/master] branch
* Foundation5[http://foundation.zurb.com/] enabled — foundation[https://github.com/LewsNetters/rails4-LewsNetter/tree/foundation] branch
...
Gemfile is configured for OSX development. See comments in Gemfile for Linux.
  ...
  git clone https://github.com/LewsNetters/rails4-LewsNetter.git
  cd rails4-LewsNetter
...
Modify config/locales/en.yml. Replace references to LewsNetter.

Modify config/application.rb. Replace references to LewsNetter.
...
{<img src="https://travis-ci.org/LewsNetters/rails4-LewsNetter.png?branch=master" alt="Build Status" />}[https://travis-ci.org/LewsNetters/rails4-LewsNetter]
...
LewsNetter is pre-configured to make it easy to deploy apps into production environments.
...
* setup Errbit or Airbrake and configure LewsNetter to track errors
...
To merge changes from Starter Kit
  ...
  git remote add upstream https://github.com/LewsNetters/rails4-LewsNetter.git
